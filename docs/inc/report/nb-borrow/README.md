...
- [`fusion_kernel_20260809`](fusion_kernel_20260809/README.md)：Fusion kernel 算子级与 persistent-service sweep。
- [`fusion_kernel_baselines_20260809`](fusion_kernel_baselines_20260809/README.md)：算子基线和早期原生 vLLM 对照。
- [`fusion_kernel_vllm_bridge_20260809`](fusion_kernel_vllm_bridge_20260809/README.md)：Torch/vLLM bridge、路由和 ABI v3/v6
  历史资格化数据。
- [`fusion_kernel_vllm_e2e_comparison_20260809`](fusion_kernel_vllm_e2e_comparison_20260809/README.md)：保留的 ABI v9 W2/W4 × 五路径
