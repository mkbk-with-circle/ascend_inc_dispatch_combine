...
当前独立算子入口：
[`inc_dc_pull_v2_api.h`](shmem/examples/inc/dispatch_combine/single_inc/pull_combine/inc_dc_pull_v2_api.h)。
完整示例：
[`inc_dc_pull_v2_api_example.cpp`](shmem/examples/inc/dispatch_combine/single_inc/pull_combine/inc_dc_pull_v2_api_example.cpp)。
