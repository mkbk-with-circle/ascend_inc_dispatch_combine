...
<!-- English -->
> **English:** This README documents the classic and dual-plane MoE Dispatch example directory.
...
<!-- English -->
### English — Selection guidance

Start with the baseline path for correctness and comparison, then use the optimized variant for the workload characteristics described above.
