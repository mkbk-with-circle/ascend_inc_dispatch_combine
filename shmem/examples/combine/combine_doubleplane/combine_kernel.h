 ...
 */
#ifndef COMBINE_KERNEL_H
#define COMBINE_KERNEL_H
...
void combine_demo(uint32_t block_dim, void *stream, uint64_t fftsAddr, uint8_t *expand_x,
                  ...
                  int moe_expert_num, int magic, int perf_mode = 0, int full_frame_id = 0,
                  int comm_frame_id = 1, int warmup_count = 0, int loop_count = 1);

#endif // COMBINE_KERNEL_H
